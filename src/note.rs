...
impl Note {
    pub fn new(waveform: Waveform, frequency: f32, lfo_waveform: Waveform, lfo_frequency: f32, lfo_amplitude: f32, attack: f32, decay: f32, sustain: f32, release: f32, env_kind: EnvelopeKind) -> Self {
        Self {
    ...
    pub fn from_env(waveform: Waveform, frequency: f32, lfo_amplitude: f32, lfo: Oscillator, envelope: Envelope) -> Self {
        Self {
            oscillator: Oscillator::new(waveform, frequency),
            lfo,
            envelope,
